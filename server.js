...
app.use(cors({
    origin: function (origin, callback) {
        ...
        if (allowedOrigins.includes(origin) || origin?.startsWith('https://pimek5.github.io') || origin?.endsWith('.railway.app')) {
            callback(null, true);
        } else {
...
app.use('/api/launcher', require('./routes/launcher')); // Launcher endpoints
